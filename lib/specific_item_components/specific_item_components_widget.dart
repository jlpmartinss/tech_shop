...
class SpecificItemComponentsWidget extends StatefulWidget {
  const SpecificItemComponentsWidget({Key key}) : super(key: key);

  @override
  _SpecificItemComponentsWidgetState createState() =>
      _SpecificItemComponentsWidgetState();
}

class _SpecificItemComponentsWidgetState
    extends State<SpecificItemComponentsWidget> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: StreamBuilder<List<ComponentsRecord>>(
          ...
          builder: (context, snapshot) {
            ...
            List<ComponentsRecord> textComponentsRecordList = snapshot.data;
            // Return an empty Container when the document does not exist.
            if (snapshot.data.isEmpty) {
              return Container();
            }
            final textComponentsRecord = textComponentsRecordList.isNotEmpty
                            ...
                            children: [
                              StreamBuilder<List<ComponentsRecord>>(
                                ...
                                builder: (context, snapshot) {
                                  ...
                                  List<ComponentsRecord>
                                      textComponentsRecordList = snapshot.data;
                                  // Return an empty Container when the document does not exist.
                                  if (snapshot.data.isEmpty) {
                                    return Container();
                                  }
