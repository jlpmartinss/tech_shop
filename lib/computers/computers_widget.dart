...
class ComputersWidget extends StatefulWidget {
  const ComputersWidget({
    Key key,
    this.desktopDetails,
  }) : super(key: key);
  ...
  @override
  _ComputersWidgetState createState() => _ComputersWidgetState();
}

class _ComputersWidgetState extends State<ComputersWidget> {
            ...
            StreamBuilder<List<ProductsRecord>>(
              stream: queryProductsRecord(
                queryBuilder: (productsRecord) => productsRecord
                    .where('category', isEqualTo: FFAppState().Desktops)
                    .orderBy('name'),
              ),
                    ...
                    return InkWell(
                      onTap: () async {
                        await Navigator.push(
                          context,
                          MaterialPageRoute(
                            builder: (context) => SpecificDesktopWidget(
                              desktopDetails: wrapProductsRecord.reference,
                            ),
                          ),
                        );
                      },
